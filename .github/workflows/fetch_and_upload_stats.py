...
def fetch_num_closed_prs_yesterday():
  ...
  url_closed_prs_this_week = f"{GITHUB_API_URL}/repos/aws-actions/{REPO_NAME}/search/issues?q=is:pr+is:closed+repo:{REPO_NAME}+closed:>=2024-01-01+closed:<=2024-12-31"
