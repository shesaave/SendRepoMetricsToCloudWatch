...
def fetch_num_closed_prs_yesterday():
  ...
  start_of_week_datetime = datetime.combine(start_of_week, datetime.min.time(0, 0, 0, 0))
  end_of_week_datetime = datetime.combine(end_of_week, datetime.max.time(23, 59, 59, 999999))
